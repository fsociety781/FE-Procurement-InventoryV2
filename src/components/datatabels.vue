<template>
  <div :class="[ { ['table-responsive']: true }, { ['table-dark']: false } ]">
    ...
    <div v-else class="table-responsive-inner">
      <div v-if="header" class="d-flex justify-content-between mx-2 px-3">
        <div v-if="limitable" class="">
          <div :class="['form-group', 'my-3', { 'form-dark': false }]">
      ...
      <div class="table-responsive">
        ...
        >
          ...
          <tbody v-if="paginatedItems.length" :class="{ ['tbody-dark']: false }">
      ...
      <div v-if="footer" class="row mx-2 my-3 d-flex align-items-center">
        ...
        <div v-if="paginate && paginateLinks.length" class="col-md-6">
          <base-pagination
            v-model.number="currentPage"
            :page-count="paginateLinks.length"
          ></base-pagination>
        </div>
      </div>
