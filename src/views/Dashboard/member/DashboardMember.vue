...
<script>
  ...
  import d$DashboardMember from "@/stores/dashboard/member/DashboardMember";
  ...
  export default {
    ...
    computed : {
    ...mapState(d$DashboardMember, ["g$list","g$overview"]), 
    },
    methods:{
      ...mapActions(d$DashboardMember, ["a$list",
"a$update",
"a$getById",]),
  async getList() {
    try {
